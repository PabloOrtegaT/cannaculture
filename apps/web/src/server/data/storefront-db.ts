...
const additionalProductsByProfile: Record<StoreProfile, Product[]> = {
  "prints-3d": [],
  "pc-components": [
    productSchema.parse({
      id: "7f64e34f-3440-441e-b4d1-3958092d0452",
      categoryId: "81d2d378-f0e3-4f13-8cf8-1ece386fddad",
      name: "Ryzen 7 7800X3D",
      slug: "ryzen-7-7800x3d",
      description: "8-core gaming-focused CPU for AM5 builds.",
      baseSku: "PC-CPU-7800X3D",
      status: "active",
      currency: "MXN",
      priceCents: 789900,
    ...
    productSchema.parse({
      id: "ef9ec886-9cc2-46d5-98b7-696ad1298b0b",
      categoryId: "81d2d378-f0e3-4f13-8cf8-1ece386fddad",
      name: "DDR5 32GB 6000MHz Kit",
      slug: "ddr5-32gb-6000mhz-kit",
      description: "Low-latency dual-channel DDR5 memory kit.",
      baseSku: "PC-RAM-DDR5-32-6000",
      status: "active",
      currency: "MXN",
      priceCents: 269900,
      compareAtPriceCents: 309900,
      tags: ["pc", "ram", "ddr5"],
      createdAt: "2026-02-12T10:00:00.000Z",
      updatedAt: "2026-03-09T15:00:00.000Z",
    }),
    productSchema.parse({
      id: "49e675fd-c566-49ec-ad6d-ebad32665b31",
      categoryId: "81d2d378-f0e3-4f13-8cf8-1ece386fddad",
      name: "NVMe SSD 1TB Gen4",
      slug: "nvme-ssd-1tb-gen4",
      description: "High-speed PCIe Gen4 M.2 storage drive.",
      baseSku: "PC-SSD-NVME-1TB-G4",
      status: "active",
      currency: "MXN",
      priceCents: 179900,
    ...
    productSchema.parse({
      id: "f6de5df2-90ab-4d53-9c5f-fd583e6c6b2f",
      categoryId: "81d2d378-f0e3-4f13-8cf8-1ece386fddad",
      name: "750W Gold PSU",
      slug: "750w-gold-psu",
      description: "Fully modular power supply with 80+ Gold efficiency.",
      baseSku: "PC-PSU-750-GOLD",
      status: "active",
      currency: "MXN",
      priceCents: 209900,
...
const variantsByProfile: Record<StoreProfile, ProductVariant[]> = {
  ...
  "pc-components": [
    ...
    productVariantSchema.parse({
      id: "7992624d-df54-4104-9f6f-3b8e6ea65ea2",
      productId: "7f64e34f-3440-441e-b4d1-3958092d0452",
      sku: "PC-CPU-7800X3D-BOX",
      name: "Retail Box",
      priceCents: 789900,
      compareAtPriceCents: 849900,
      stockOnHand: 12,
    ...
    productVariantSchema.parse({
      id: "ea2ce9e5-fb68-425f-8dc8-82ee4316d266",
      productId: "ef9ec886-9cc2-46d5-98b7-696ad1298b0b",
      sku: "PC-RAM-DDR5-32-6000-CL30",
      name: "CL30 Kit",
      priceCents: 269900,
      compareAtPriceCents: 309900,
      stockOnHand: 18,
    ...
    productVariantSchema.parse({
      id: "2287e8f3-cd4f-40cd-84eb-c2dc186ea9f6",
      productId: "49e675fd-c566-49ec-ad6d-ebad32665b31",
      sku: "PC-SSD-NVME-1TB-G4-HEATSINK",
      name: "With Heatsink",
      priceCents: 179900,
      compareAtPriceCents: 209900,
      stockOnHand: 24,
    ...
    productVariantSchema.parse({
      id: "7c6fffa5-8a14-4715-ad27-e6f6807f7d0f",
      productId: "f6de5df2-90ab-4d53-9c5f-fd583e6c6b2f",
      sku: "PC-PSU-750-GOLD-ATX",
      name: "ATX 3.0 Edition",
      priceCents: 209900,
      compareAtPriceCents: 239900,
      stockOnHand: 15,
      isDefault: true,
...
const featuredSalesByProfile: Record<StoreProfile, FeaturedSale[]> = {
  ...
  "pc-components": [
    featuredSaleSchema.parse({
      ...
      productIds: [
        "2e06737a-1191-4148-83f3-d95ff8d7f5aa",
        "7f64e34f-3440-441e-b4d1-3958092d0452",
        "ef9ec886-9cc2-46d5-98b7-696ad1298b0b",
      ],
      startsAt: "2026-03-01T00:00:00.000Z",
      endsAt: "2026-03-31T23:59:59.000Z",
      isActive: true,
...
const storefrontSeedByProfile: Record<StoreProfile, StorefrontSeed> = {
  ...
  "pc-components": {
    ...
    products: [productByProfile["pc-components"], ...additionalProductsByProfile["pc-components"]],
